                ...
                <table>
                    ...
                    <c:forEach items="${anzeigen}" var="anzeige">
                        <tr>
                            ...
                            <td>
                                <c:out value="${utils.formatDate(anzeige.anzeige_erstelle_Datum)}"/>
                                <c:out value="${utils.formatTime(anzeige.anzeige_erstelle_Zeit)}"/>
                            </td>
                            <td>
                                <c:out value="${anzeige.anzeige_preis}"/>
                            </td>
                            <td>
                                <c:out value="${anzeige.anzeige_preistyp.label}"/>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
