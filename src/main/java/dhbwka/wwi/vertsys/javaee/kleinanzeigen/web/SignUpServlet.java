...
public class SignUpServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String user_firstname = request.getParameter("signup_user_firstname");
        String user_lastname = request.getParameter("signup_user_lastname");
        String user_phonenumber = request.getParameter("signup_user_phonenumber");
        String user_adress = request.getParameter("signup_user_adress");
        String user_email = request.getParameter("signup_user_email");
        String user_city = request.getParameter("signup_user_city");
        String user_postcode = request.getParameter("signup_user_postcode");

        // Eingaben prüfen
        User user = new User(username, password1, user_firstname, user_lastname,
                user_phonenumber, user_email, user_adress, user_postcode, user_city);
        ...
        if (errors.isEmpty()) {
            try {
                this.userBean.signup(username, password1, user_firstname, user_lastname,
                        user_phonenumber, user_email, user_adress, user_postcode, user_city);
